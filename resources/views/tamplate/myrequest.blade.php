...
<div class="container" dir="rtl">
    <h2 dir="rtl">تقرير عن طلباتي</h2>

    <div class="table-responsive" dir="rtl">
        <table class="table">
            <thead style="text-align: right; background-color: #99ccff;" >
            <tr>
                <th style="text-align: right;">الرقم</th>
                <th style="text-align: right;">العنوان</th>
                <th style="text-align: right;"> نوع الشكوى - الاقتراح - مياه - كهرباء</th>
            ...
            @foreach($cs as $item)
                ...
                @if($item->accept == "accept")
                    <tr class="table-success">
                @elseif ($item->accept == "reject")
                ...
                @else
                    ...
                    @foreach($electrical_water as $item)
